...
;;ui
;;;;blur background only for emacs-mac;
(when IS-MAC
 ...
 (defface my/default-blurred
       '((t :inherit 'default :stipple "alpha:37%"))
...
(setq doom-font (font-spec :family "Roboto Mono" :size 17 :weight 'Medium)
      ...
      doom-serif-font (font-spec :family "Roboto Slab" :weight 'Regular :size 21))
;;
...
;; `doom-dracula' for dark theme, `tsdh-light'for light theme, `doom-flatwhite'for mirage.
